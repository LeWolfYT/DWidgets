...
def draw_label():
    ...
    label.config(text=str(round(temp,1))+"°C")
    #wait one minute
...
def get_weather(lat, lon):
    ...
    weather = requests.get("https://api.openweathermap.org/data/2.5/onecall?lat="+str(lat)+"&lon="+str(lon)+"&exclude=minutely,hourly&units=metric&appid=429f9fac553fdb5c97dc4231ab98024f").json()
